...
<body>
	...
	<c:set var="c" />
	<c:set var="c" value="" />
	<c:set var="c" value="null" /> <!-- 자바의 null이 아니라 "null" -->
	<div>c: ${c}</div>
	<div>c: ${empty c}</div>
	<div>c: ${empty d}</div>
	...
	<div><a href="http://localhost:8090/jsp/ex20_form.jsp?name=hong&age=20&gender=m">페이지 이동하기</a></div>

	<c:url var="url1" value="http://localhost:8090/jsp/ex20_form.jsp">
