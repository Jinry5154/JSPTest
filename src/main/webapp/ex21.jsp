...
<%
	...
	//시간 순서대로 정렬
	//System.out.println(list[0].lastModified()); //1741244608832
...
<body>
	...
	<div id="list">
		<% for (File file : list) { %>
		<div data-modal-button="view" data-filename="<%= file.getName() %>" onclick="show();">
		<img src="pic/<%= file.getName() %>">
		<span class="delete" onclick="del('<%= file.getName() %>');">&times;</span>
		</div>
		<% } %>
	</div>
