...
<body>
	...
	<table class="vertical">
		<tr>
			<th>너비(px)</th>
			<td><input type="number" name="width" min="20" max="300" step="10" value="120" class="short"></td>
		</tr>
		<tr>
			<th>높이(px)</th>
			<td><input type="number" name="height" min="10" max="200" step="10" value="30" class="short"></td>
		</tr>
		<tr>
			<th>텍스트</th>
			<td><input type="text" name="text" class="short" value="Button"></td>
		</tr>
		<tr>
			<th>배경색</th>
		...
		<tr>
			<th>글자색</th>
			<td><input type="color" name="txtColor" value="#000000" style="height: 35px;"></td>
		</tr>
		<tr>
			<th>글자 크기(px)</th>
		...
		<tr>
			...
			<td>
				<div>
					좌우 간격 : 
					<input type="range" min="0" max="50" value="0" name="leftright">
				</div>
				<div>
					상하 간격 : 
					<input type="range" min="0" max="50" value="0" name="topbottom">
				</div>
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<div id="borderbox" style="display: none;">
